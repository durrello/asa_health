...
include "php/headerContact.php";
?>
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
  <div class="container">
    <a class="navbar-brand" href="index.php">AsaHealth</a>
      ...
      <div class="col-lg-8 ftco-animate">
        ...
        <div id="post2">
          ...
          <p>
            ...
            (Solvaldi exhibits a 90% cure rate for those recently infected), there is still an almost
            insurmountable barrier to care. A twelve-week treatment of Solvaldi costs roughly $84,000.
            Olysio comes in at a slightly more economical rate of $66,000 per twelve-week course. With
            these figures in mind, one may see the task of addressing HCV in economically depressed regions
            as near impossible. Although treatment therapies for those living and recently infected on the
            African continent may be difficult,it is important to take note of the efforts that can be made in prevention of the virus.
          </p>
        </div>
        ...
        <!-- third post  -->
        <div id="post3">
          <h2 class="mb-3 mt-5"><strong>#3. Supporting Senegalese Midwives and Birth Attendants, a lesson from the African Midwives Collective</strong></h2>
          <p>
            “Midwives provide amazing services to our communities. Aside from assisting with births,
      ...
      <div class="col-lg-4 sidebar ftco-animate">
        ...
        <div class="sidebar-box ftco-animate">
          ...
          <div class="block-21 mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url(images/blog/blog1.jpg);"></a>
            <div class="text">
              <h3 class="heading"><a href="#post1">Breast cancer in young women</a></h3>
              <div class="meta">
                <div><a><span class="icon-calendar"></span>September 22, 2022</a></div>
              </div>
            </div>
          </div>
          ...
          <!-- second post  -->
          <div class="block-21 mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url(images/blog/blog2.jpg);"></a>
            <div class="text">
              <h3 class="heading"><a href="#post2">Blood Screenings How much is too much to prevent Hepatitis C?</a></h3>
              <div class="meta">
                <div><a><span class="icon-calendar"></span>June 1, 2014</a></div>
              </div>
            </div>
          </div>
          ...
          <!-- third post  -->
          <div class="block-21 mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url(images/blog/blog3.jpg);"></a>
            <div class="text">
              <h3 class="heading"><a href="#post3">Supporting Senegalese Midwives and Birth Attendants, a lesson from the African Midwives Collective</a></h3>
              <div class="meta">
